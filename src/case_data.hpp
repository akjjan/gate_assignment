...
caseData makeCaseData(int flightNumber, int gateNumber, int bufferTime,
                      ...
                      const map<int, int> &delta,
                      const vector<int> &mediumGates,
                      const vector<int> &largeFlights,
                      const vector<vector<double>> &towCost, const vector<vector<double>> &towTime)
{
    caseData data;
